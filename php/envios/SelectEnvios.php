...
if($cve=='null'){
    if($select == '0') {
        $sql = "SELECT 
                ...
                GROUP BY E.CVE_ENVIO, E.ENTREGADO, C.NOMBRE, I.NOMBRE, I.UNIDAD, MO.NOMBRE, CO.NOMBRE, E.ORIGEN, V.TIPO, V.PLACA, CONCAT(U.NOMBRE,' ',U.APELLIDO_P,' ',U.APELLIDO_M), MD.NOMBRE, CD.NOMBRE, E.DESTINO, E.FECHASALIDA, E.FECHALLEGADA, E.COSTO, E.OBSERVACIONES;";
    } if($select == '1') {
        $sql = "SELECT 
                    E.CVE_ENVIO AS NENVIO,
                    E.ENTREGADO AS ENTREGADO,
                ...
                LEFT JOIN items AS I ON I.CVE_ITEM = EN.CVE_ITEM
                LEFT JOIN compradores AS C ON C.CVE_COMPRADOR = P.CVE_COMPRADOR
                WHERE E.ENTREGADO = '0' GROUP BY E.CVE_ENVIO, E.ENTREGADO, C.NOMBRE, I.NOMBRE, I.UNIDAD, MO.NOMBRE, CO.NOMBRE, E.ORIGEN, V.TIPO, V.PLACA, CONCAT(U.NOMBRE,' ',U.APELLIDO_P,' ',U.APELLIDO_M), MD.NOMBRE, CD.NOMBRE, E.DESTINO, E.FECHASALIDA, E.FECHALLEGADA, E.COSTO, E.OBSERVACIONES;";
        } if($select == '2') {
            $sql = "SELECT 
                    E.CVE_ENVIO AS NENVIO,
                    E.ENTREGADO AS ENTREGADO,
                ...
                LEFT JOIN items AS I ON I.CVE_ITEM = EN.CVE_ITEM
                LEFT JOIN compradores AS C ON C.CVE_COMPRADOR = P.CVE_COMPRADOR
                WHERE E.ENTREGADO = '1' GROUP BY E.CVE_ENVIO, E.ENTREGADO, C.NOMBRE, I.NOMBRE, I.UNIDAD, MO.NOMBRE, CO.NOMBRE, E.ORIGEN, V.TIPO, V.PLACA, CONCAT(U.NOMBRE,' ',U.APELLIDO_P,' ',U.APELLIDO_M), MD.NOMBRE, CD.NOMBRE, E.DESTINO, E.FECHASALIDA, E.FECHALLEGADA, E.COSTO, E.OBSERVACIONES;";
    }
} else {
