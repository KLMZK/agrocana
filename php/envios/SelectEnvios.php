...
if($cve=='null'){
    if($select == '0') {
        $sql = "SELECT E.CVE_ENVIO AS NENVIO, E.ENTREGADO AS ENTREGADO, C.NOMBRE AS CLIENTE, I.NOMBRE AS ITEM, EN.CANTIDAD AS CANTIDAD, I.UNIDAD AS UNIDAD, MO.NOMBRE AS MORIGEN, CO.NOMBRE AS CORIGEN, E.ORIGEN AS CALLEORIGEN, V.TIPO AS VEHICULO, V.PLACA AS PLACA, U.NOMBRE AS CONDUCTOR, U.APELLIDO_P AS CONDUCTOR1, U.APELLIDO_M AS CONDUCTOR2, MD.NOMBRE AS MDESTINO, CD.NOMBRE AS CDESTINO, E.DESTINO AS CALLEDESTINO, E.FECHASALIDA AS FECHASALIDA, E.FECHALLEGADA AS FECHALLEGADA, E.COSTO AS COSTO, E.OBSERVACIONES AS NOTA FROM envios AS E LEFT JOIN vehiculos AS V ON V.PLACA = E.PLACA LEFT JOIN usuarios AS U ON E.CVE_CONDUCTOR = U.CVE_USUARIO LEFT JOIN colonias AS CO ON CO.CVE_COLONIA = E.COLONIAORIGEN LEFT JOIN colonias AS CD ON CD.CVE_COLONIA = E.COLONIADESTINO LEFT JOIN municipios AS MO ON MO.CVE_MUNICIPIO = CO.CVE_MUNICIPIO LEFT JOIN municipios AS MD ON MD.CVE_MUNICIPIO = CD.CVE_MUNICIPIO LEFT JOIN pedidos AS P ON E.CVE_PEDIDO = P.CVE_PEDIDO LEFT JOIN encarga AS EN ON EN.CVE_PEDIDO = P.CVE_PEDIDO LEFT JOIN items AS I ON I.CVE_ITEM = EN.CVE_ITEM LEFT JOIN compradores AS C ON C.CVE_COMPRADOR = P.CVE_COMPRADOR GROUP BY E.CVE_ENVIO";
    } if($select == '1') {
        $sql = "SELECT E.CVE_ENVIO AS NENVIO, E.ENTREGADO AS ENTREGADO, C.NOMBRE AS CLIENTE, I.NOMBRE AS ITEM, EN.CANTIDAD AS CANTIDAD, I.UNIDAD AS UNIDAD, MO.NOMBRE AS MORIGEN, CO.NOMBRE AS CORIGEN, E.ORIGEN AS CALLEORIGEN, V.TIPO AS VEHICULO, V.PLACA AS PLACA, U.NOMBRE AS CONDUCTOR, U.APELLIDO_P AS CONDUCTOR1, U.APELLIDO_M AS CONDUCTOR2, MD.NOMBRE AS MDESTINO, CD.NOMBRE AS CDESTINO, E.DESTINO AS CALLEDESTINO, E.FECHASALIDA AS FECHASALIDA, E.FECHALLEGADA AS FECHALLEGADA, E.COSTO AS COSTO, E.OBSERVACIONES AS NOTA FROM envios AS E LEFT JOIN vehiculos AS V ON V.PLACA = E.PLACA LEFT JOIN usuarios AS U ON E.CVE_CONDUCTOR = U.CVE_USUARIO LEFT JOIN colonias AS CO ON CO.CVE_COLONIA = E.COLONIAORIGEN LEFT JOIN colonias AS CD ON CD.CVE_COLONIA = E.COLONIADESTINO LEFT JOIN municipios AS MO ON MO.CVE_MUNICIPIO = CO.CVE_MUNICIPIO LEFT JOIN municipios AS MD ON MD.CVE_MUNICIPIO = CD.CVE_MUNICIPIO LEFT JOIN pedidos AS P ON E.CVE_PEDIDO = P.CVE_PEDIDO LEFT JOIN encarga AS EN ON EN.CVE_PEDIDO = P.CVE_PEDIDO LEFT JOIN items AS I ON I.CVE_ITEM = EN.CVE_ITEM LEFT JOIN compradores AS C ON C.CVE_COMPRADOR = P.CVE_COMPRADOR WHERE E.ENTREGADO = '0' GROUP BY E.CVE_ENVIO;";
    } if($select == '2') {
        $sql = "SELECT E.CVE_ENVIO AS NENVIO, E.ENTREGADO AS ENTREGADO, C.NOMBRE AS CLIENTE, I.NOMBRE AS ITEM, EN.CANTIDAD AS CANTIDAD, I.UNIDAD AS UNIDAD, MO.NOMBRE AS MORIGEN, CO.NOMBRE AS CORIGEN, E.ORIGEN AS CALLEORIGEN, V.TIPO AS VEHICULO, V.PLACA AS PLACA, U.NOMBRE AS CONDUCTOR, U.APELLIDO_P AS CONDUCTOR1, U.APELLIDO_M AS CONDUCTOR2, MD.NOMBRE AS MDESTINO, CD.NOMBRE AS CDESTINO, E.DESTINO AS CALLEDESTINO, E.FECHASALIDA AS FECHASALIDA, E.FECHALLEGADA AS FECHALLEGADA, E.COSTO AS COSTO, E.OBSERVACIONES AS NOTA FROM envios AS E LEFT JOIN vehiculos AS V ON V.PLACA = E.PLACA LEFT JOIN usuarios AS U ON E.CVE_CONDUCTOR = U.CVE_USUARIO LEFT JOIN colonias AS CO ON CO.CVE_COLONIA = E.COLONIAORIGEN LEFT JOIN colonias AS CD ON CD.CVE_COLONIA = E.COLONIADESTINO LEFT JOIN municipios AS MO ON MO.CVE_MUNICIPIO = CO.CVE_MUNICIPIO LEFT JOIN municipios AS MD ON MD.CVE_MUNICIPIO = CD.CVE_MUNICIPIO LEFT JOIN pedidos AS P ON E.CVE_PEDIDO = P.CVE_PEDIDO LEFT JOIN encarga AS EN ON EN.CVE_PEDIDO = P.CVE_PEDIDO LEFT JOIN items AS I ON I.CVE_ITEM = EN.CVE_ITEM LEFT JOIN compradores AS C ON C.CVE_COMPRADOR = P.CVE_COMPRADOR WHERE E.ENTREGADO = '1' GROUP BY E.CVE_ENVIO";
    }
} else {
